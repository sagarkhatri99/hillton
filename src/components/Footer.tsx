  ...
  return (
    <footer className="relative bg-primary-hover text-white pt-16 pb-8 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
        <Image
          src="/images/new/footer-garden.avif"
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            <h3 className="font-serif text-xl mb-4 text-cream-100">
              Quick Links
            </h3>
          ...
          <div>
            ...
            <div className="space-y-4 font-sans pb-4">
              <a
                href="https://www.instagram.com/hillton_chikitsa_kendra/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 hover:text-white transition group text-primary-100/90 text-sm"
              >
                <Instagram
                  size={24}
                ...
                <span className="group-hover:translate-x-1 transition-transform">
                  @hillton_chikitsa_kendra
                </span>
              </a>
              <a
                href="https://www.facebook.com/p/Hilton-Parakrtik-Chikitsa-Kendra-61571774392786/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 hover:text-white transition group text-primary-100/90 text-sm"
              >
