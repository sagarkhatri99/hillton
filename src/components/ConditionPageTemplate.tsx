...
export default function ConditionPageTemplate({
    ...
    return (
            ...
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4 max-w-4xl">
                    <div className="prose prose-lg md:prose-xl text-stone-600 leading-relaxed mx-auto">
                        <h2 className="font-serif text-3xl text-primary font-bold mb-8">{whatIsSection.title}</h2>
      ...
      --------------------------------------------------------------------------- */}
            <section className="py-20 bg-stone-50">
                <div className="container mx-auto px-4 max-w-5xl">
                    <h2 className="font-serif text-3xl md:text-4xl text-primary font-bold text-center mb-12">Common Symptoms</h2>
      ...
      --------------------------------------------------------------------------- */}
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4 max-w-4xl">
                    <h2 className="font-serif text-3xl md:text-4xl text-primary font-bold text-center mb-8">{rootCauses.title}</h2>

                    {rootCauses.content.length > 0 && (
                        <div className="prose prose-lg text-stone-600 mb-8 mx-auto">
      ...
      --------------------------------------------------------------------------- */}
            <section className="py-20 bg-teal-800 text-cream-50">
                <div className="container mx-auto px-4 max-w-5xl">
                    <h2 className="font-serif text-3xl md:text-4xl font-bold text-center mb-6">{approachSection.title}</h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        {approachSection.therapies.map((therapy, index) => (
                            <div key={index} className="card-hover bg-teal-900/50 p-8 rounded-2xl border border-teal-700 hover:bg-teal-900/70 transition">
                                <h3 className="font-serif text-2xl font-bold text-cream-50 mb-4">{therapy.title}</h3>
                                {therapy.description && <p className="text-teal-100 mb-4">{therapy.description}</p>}

                                {therapy.items && (
                                    <ul className="space-y-2 mb-6">
                                        {therapy.items.map((item, i) => (
                                            <li key={i} className="flex gap-3 text-teal-100/90 text-sm">
      ...
      --------------------------------------------------------------------------- */}
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4 max-w-4xl">
                    <h2 className="font-serif text-3xl md:text-4xl text-primary font-bold text-center mb-16">{timeline.title}</h2>
                    ...
                    <div className="relative border-l-2 border-stone-200 ml-4 md:ml-8 space-y-12 pb-8">
                        {timeline.steps.map((step, index) => (
                            <div key={index} className="relative pl-8 md:pl-12">
                                ...
                                <h3 className="font-serif text-xl font-bold text-stone-800 mb-4">{step.title}</h3>
      ...
      --------------------------------------------------------------------------- */}
            <section className="py-20 bg-stone-50">
                <div className="container mx-auto px-4 max-w-4xl">
                    <h2 className="font-serif text-3xl md:text-4xl text-primary font-bold text-center mb-12">How You'll Know It's Working</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      --------------------------------------------------------------------------- */}
            <section className="py-20 bg-white">
                <div className="container mx-auto px-4 max-w-3xl">
                    <h2 className="font-serif text-3xl md:text-4xl text-primary font-bold text-center mb-12">Common Questions</h2>
                    <div className="space-y-4 mb-20">
                        {faqs.map((faq, index) => (
                            <div key={index} className="bg-stone-50 rounded-xl border border-stone-100 overflow-hidden">
                                ...
                                >
                                    <h3 className="font-bold text-lg text-stone-800">{faq.question}</h3>
                                    <ArrowRight
                                        size={20}
                    ...
                    <div className="text-center bg-teal-900 rounded-3xl p-10 md:p-16 text-cream-50">
                        <h2 className="font-serif text-3xl md:text-4xl font-bold mb-6">{cta.text}</h2>
                        <Link href={cta.link} className="btn-hover bg-secondary hover:bg-secondary-light text-white px-10 py-5 rounded-full text-lg font-medium transition shadow-lg hover:shadow-xl inline-flex items-center gap-2">
